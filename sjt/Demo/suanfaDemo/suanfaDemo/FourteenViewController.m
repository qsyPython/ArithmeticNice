...
- (void)viewDidLoad {
    [super viewDidLoad];
    NSString *originStr = @"UUDDL";
    BOOL isOriginCicle = [self judgeCircle:originStr];
    // Do any additional setup after loading the view.
}

- (BOOL)judgeCircle:(NSString *)originStr {
    int x = 0;
    int y = 0;
    for (int i =0; i<originStr.length; i++) {
        NSString *str = [originStr substringWithRange:NSMakeRange(i, 1)];
